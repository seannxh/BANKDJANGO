...
from bankingapp.views import SignUpView, SignInView, UserBankAccountsView, SendMoneyView, DepositMoneyView, CreateBankAccountView, UpdateBalanceView, DeleteBankAccountView
